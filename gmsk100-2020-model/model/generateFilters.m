...
Trad = numerictype(1,16,13); %This is for setting the type the numbers we use
...
frequencies = [0, 0.01, 0.01, 0.79, 0.79, 0.81,0.81, 1];
magnitude = [1, 1, 0, 0, 0, 0, 0, 0];
weights = [100, 1, 100, 1];
% frequencies = [0, 0.004, 0.15, 0.2, 0.20, 1];
...
freqz(filterInBin.data, 1, 40000, 100000);
